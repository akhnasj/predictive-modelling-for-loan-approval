...
class _LoanFormPageState extends State<LoanFormPage> {
  ...
  Future<void> checkLoanApproval() async {
    try {
      final response = await http.post(
        Uri.parse(
            "http://192.168.47.104:8000/predict"), // Change this if deployed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Loan Approval Form")),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildDropdown("Has Dependents", ["Yes", "No"], (value) {
              setState(() {
                hasDependents = value!;
              });
            }),
            ...
            _buildDropdown("Has Co-Signer", ["Yes", "No"], (value) {
              setState(() {
                hasCoSigner = value!;
              });
            }),
            _buildDropdown("Default", ["Yes", "No"], (value) {
              setState(() {
                defaultStatus = value!;
              });
            }),
